  ...
  return (
    <div style={{ width: "100%", background: "var(--bg)", color: "var(--ink)", ...CSS }}>
      ...
      <section className="au-hero-padding" style={{ padding: "64px 56px 32px" }}>
        ...
        <h1 style={{ fontWeight: 600, fontSize: "clamp(36px, 10vw, 168px)", lineHeight: 1.0, letterSpacing: "0.12em", fontKerning: "none", fontVariantLigatures: "none", margin: "0 0 56px", wordBreak: "break-word" }}>
          Peer produced<br />
          <span style={{ color: A.main, letterSpacing: "0.12em" }}>proficiency.</span>
        </h1>
