  ...
  return (
    <div style={{ width: "100%", background: "var(--bg)", color: "var(--ink)", ...CSS }}>
      ...
      <section className="au-hero-padding" style={{ padding: "64px 56px 32px", position: "relative" }}>
        ...
        <div className="au-hero-annotation" style={{ position: "absolute", top: 0, right: 120, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6, pointerEvents: "none" }}>
          ...
          <div style={{ fontSize: 14, fontWeight: 500, color: "var(--ink-2)", textAlign: "right", lineHeight: 1.4, maxWidth: 240, fontStyle: "italic", whiteSpace: "nowrap" }}>
