  ...
  return (
    <div style={{ width: "100%", background: "var(--bg)", color: "var(--ink)", ...CSS }}>
      ...
      <section className="au-hero-padding" style={{ padding: "64px 56px 32px", position: "relative" }}>
        ...
        <div className="au-hero-annotation" style={{ position: "absolute", top: 0, right: 60, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6, pointerEvents: "none" }}>
