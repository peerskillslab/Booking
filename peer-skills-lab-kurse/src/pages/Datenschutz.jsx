...
export default function Datenschutz() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 space-y-8" style={{ fontFamily: "var(--psl-font, -apple-system, sans-serif)" }}>
      <h1 style={{ fontSize: 26, fontWeight: 800, fontFamily: "'Plus Jakarta Sans', sans-serif", marginBottom: 0 }}>Datenschutzerklärung</h1>

      <section className="space-y-2">
        <h2 style={{ fontSize: 14.5, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>1. Allgemeine Hinweise</h2>
      ...
      <section className="space-y-2">
        <h2 style={{ fontSize: 14.5, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>2. Verantwortliche Stelle</h2>
      ...
      <section className="space-y-2">
        <h2 style={{ fontSize: 14.5, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>3. Erhebung und Verarbeitung personenbezogener Daten</h2>
      ...
      <section className="space-y-2">
        <h2 style={{ fontSize: 14.5, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>4. Buchungssystem</h2>
      ...
      <section className="space-y-2">
        <h2 style={{ fontSize: 14.5, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>6. Cookies</h2>
      ...
      <section className="space-y-2">
        <h2 style={{ fontSize: 14.5, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>7. Weitergabe von Daten</h2>
      ...
      <section className="space-y-2">
        <h2 style={{ fontSize: 14.5, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>8. Datensicherheit</h2>
      ...
      <section className="space-y-2">
        <h2 style={{ fontSize: 14.5, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>9. Rechte der betroffenen Personen</h2>
      ...
      <section className="space-y-2">
        <h2 style={{ fontSize: 14.5, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>10. Änderungen</h2>
